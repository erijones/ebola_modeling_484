function err = seir_parameter_fit_4_06(k0)
...
f = @(t,y,k1,k2,k3,psi,eta,phi) [ (alpha*y(1) -k1*y(1)*y(3) -k2*y(1)*y(5) -k3*y(1)*y(4)) ;  (k1*y(1)*y(3)-mu*y(2) + k2*y(1)*y(5) +k3*y(1)*y(4))  ;  ...
             (mu*y(2)-gamma*y(3) -psi*y(3) ); psi*y(3)-eta*y(4)-phi*y(4) ;  rho*gamma*y(3) - beta*y(5) ; beta*y(5)+eta*y(4) ; (1-rho)*gamma*y(3) + phi*y(4) ] ;

[t,y] = ode15s(f, tSpan, y0, [],k0(1),k0(2),k0(3),k0(4),k0(5),k0(6));
...
title(sprintf('7-parameter Guinea Cases & Death Fit \n k1 = %0.3g k2 = %0.3g k3 = %0.3g psi = %0.3g eta = %0.3g phi = %0.3g',k0(1),k0(2), k0(3),k0(4), k0(5),k0(6)))
xlabel('Days')
ylabel('Population')
