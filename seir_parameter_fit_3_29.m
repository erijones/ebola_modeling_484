function err = seir_parameter_fit_3_29(k0)
...
f = @(t,y,k1,k2) [ (alpha*y(1) -k1*y(1)*y(3) -k2*y(1)*y(4)) ;  (k1*y(1)*y(3)-mu*y(2) + k2*y(1)*y(4))  ;  ...
...
title(sprintf('2-parameter Guinea Death Fit \n k1 = %0.3g, k2 = %0.3g',k0(1), k0(2)) )
xlabel('Days')
ylabel('Population')
